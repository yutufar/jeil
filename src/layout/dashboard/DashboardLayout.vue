  ...
  <div class="wrapper">
    <side-bar>
      <template slot="links">
        ...
        <sidebar-link to="/remicon/external" name="외부 지원 운행" icon="tim-icons icon-bus-front-12"/> <!-- ← 추가 -->
        ...
        <sidebar-link to="/remicon/calculator" name="레미콘 단가 계산"     icon="tim-icons icon-notes"/> <!-- ← 추가 -->
      </template>
    </side-bar>
